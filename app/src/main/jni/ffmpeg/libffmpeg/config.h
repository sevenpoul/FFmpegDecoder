...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-yasm --enable-libx264 --enable-encoder=libx264 --enable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-debug --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=aac --enable-libx264 --enable-encoder=libx264 --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-muxer=flv --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mpegps --enable-demuxer=mpegts --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --prefix=/Users/lidechen/AndroidStudioProjects/git/ffmpeg/android_demo/AndroidFFmpeg/tools/ffmpeg-build/armeabi-arm64/output --cross-prefix=aarch64-linux-android- --target-os=linux --enable-asm --enable-inline-asm --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/Users/lidechen/AndroidStudioProjects/git/ffmpeg/android_demo/AndroidFFmpeg/tools/x264-build/armeabi-arm64/output/include ' --extra-ldflags='-L/Users/lidechen/AndroidStudioProjects/git/ffmpeg/android_demo/AndroidFFmpeg/tools/x264-build/armeabi-arm64/output/lib -lx264'"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/lidechen/AndroidStudioProjects/git/ffmpeg/android_demo/AndroidFFmpeg/tools/ffmpeg-build/armeabi-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/lidechen/AndroidStudioProjects/git/ffmpeg/android_demo/AndroidFFmpeg/tools/ffmpeg-build/armeabi-arm64/output/share/ffmpeg"
